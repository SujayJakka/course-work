...
class GPacGame():
    ...
    def update_score(self, time_bonus_or_penalty=None):
        ...
        self.score_vector[0] = 100 * self.pills_consumed / total_pills
        self.score_vector[1] = self.fruit_consumed * self.fruit_score
        if time_bonus_or_penalty == 'bonus':
            self.score_vector[2] = 100 * self.time / self.total_time
        # elif time_bonus_or_penalty == 'penalty':
        #     self.score_vector[2] = -(100 * self.time / self.total_time)
        else:
            self.score_vector[2] = 0
        self.score = sum(self.score_vector)
